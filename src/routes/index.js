...
router.post('/auth/cambiar-password', auth, authController.cambiarPassword);
...
router.post('/stock/movimiento',  auth, can('stock_editar'), stockController.movimiento);

// ════════════════════════════════════
// PRODUCCION
// ════════════════════════════════════
router.get ('/produccion',               auth, can('produccion_ver'),    produccionController.listar);
router.post('/produccion',               auth, can('produccion_crear'),  produccionController.crear);
...
router.post  ('/locales',               auth, adminOnly,                localesController.crear);
router.put   ('/locales/:id',           auth, adminOnly,                localesController.actualizar);
router.delete('/locales/:id',           auth, adminOnly,                localesController.eliminar);
router.post  ('/locales/transferencia', auth, can('stock_transferir'),  localesController.transferir);
...
router.post('/precios/listas',    auth, can('precios_editar'), preciosController.crearLista);
...
router.post('/precios',           auth, can('precios_editar'), preciosController.actualizar);
router.post('/precios/ajuste',    auth, can('precios_editar'), preciosController.ajusteMasivo);
router.post('/precios/batch',     auth, can('precios_editar'), preciosController.batch);
...
router.post('/ventas',              auth, can('ventas_crear'), ventasController.crear);
...
router.post('/logistica/pedidos',             auth, can('logistica_crear'),     logisticaController.crearPedido);
router.post('/logistica/confirmar',           auth, can('logistica_confirmar'), logisticaController.confirmarEntrega);
router.post('/logistica/gps',                 auth,                             logisticaController.actualizarGPS);
router.post('/logistica/ruta-optimizada',     auth,                             logisticaController.rutaOptimizada);
router.put ('/logistica/pedidos/:id/problema',auth,                             logisticaController.reportarProblema);
...
router.post('/usuarios',                    auth, can('usuarios'), usuariosController.crear);
router.put ('/usuarios/:id',                auth, can('usuarios'), usuariosController.actualizar);
router.post('/usuarios/:id/reset-password', auth, can('usuarios'), usuariosController.resetPassword);
...
router.post('/productos',            auth, can('precios_editar'), productosController.crear);
router.put('/productos/:id',         auth, can('precios_editar'), productosController.actualizar);
